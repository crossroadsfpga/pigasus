...
set_clock_groups -exclusive  -group  $CORECLK_0  -group $CORECLKRX_0 -group $OSC_CLK  -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK0_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK1_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK0_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK1_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK2_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK3_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK2_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK3_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
