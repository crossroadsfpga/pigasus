...
#ifdef PIGASUS
    { "--patterns", Parameter::PT_STRING, nullptr, nullptr,
      "<patterns file> use this patterns file for Pigasus", },
#endif
...
#ifdef PIGASUS
    else if ( v.is("--patterns") )
        sc->sid_patterns_filename = v.get_string();
#endif
