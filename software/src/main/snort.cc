...
int zhipeng;
int zhipeng_exit;
//extern int zhipeng_pkt;
//extern int zhipeng_match_pkt_lock;
hr_duration zhipeng_duration;
//Zhipeng End
    ...
    void*, const DAQ_PktHdr_t* pkthdr, const uint8_t* pkt)
{
    ...
    //Zhipeng Start
    //printf("otnx address = %p \n",s_packet->context->otnx);
    //Zhipeng End
    ...
    zhipeng_duration += elapsed;
    //printf("duration = %llu, zhipeng duration = %llu \n", elapsed,zhipeng_duration);
    zhipeng_exit++;
    //Zhipeng End
    return verdict;
}
