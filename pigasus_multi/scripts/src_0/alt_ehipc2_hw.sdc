...
create_clock -name {CLK_DDR4_COMP_P} -period 6.024 [get_ports { CLK_DDR4_COMP_P }]
...
set USERCLK_REF  [get_clocks user_pll_inst|user_pll_refclk]
set USERCLK_FAST [get_clocks user_pll_inst|user_pll_outclk1]
...
#Zhipeng Update
set_clock_groups -exclusive  -group  $CORECLK_0  -group $CORECLKRX_0 -group $OSC_CLK  -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK

set_clock_groups -exclusive  -group  $RX_CLK0_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK1_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK0_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK1_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK2_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK3_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK2_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK3_0 -group $OSC_CLK -group $REF_CLK_0 -group $CLK100 -group $IOPLL_REF -group $CORECLK_1 -group $CORECLKRX_1 -group $REF_CLK_1 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK


set_clock_groups -exclusive  -group  $CORECLK_1  -group $CORECLKRX_1 -group $OSC_CLK  -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK -group $ESRAM_CLK -group $DRAM_CLK

set_clock_groups -exclusive  -group  $RX_CLK0_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK 
set_clock_groups -exclusive  -group  $RX_CLK1_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK0_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK1_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK2_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $RX_CLK3_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK2_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
set_clock_groups -exclusive  -group  $TX_CLK3_1 -group $OSC_CLK -group $REF_CLK_1 -group $CLK100 -group $IOPLL_REF -group $CORECLK_0 -group $CORECLKRX_0 -group $REF_CLK_0 -group $USERCLK -group $USERCLK_REF -group $USERCLK_FAST -group $PCIE_CLK  -group $ESRAM_CLK -group $DRAM_CLK
