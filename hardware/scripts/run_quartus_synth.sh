...
# copy newest source
cp $SCRIPT_DIR/src/alt_ehipc2_hw.* $quartus_project_root/hardware_test_design/
cp -r $SIM_DIR/src $quartus_project_root/hardware_test_design/
